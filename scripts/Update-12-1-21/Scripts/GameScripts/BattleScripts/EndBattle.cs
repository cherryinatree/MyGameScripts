...
public static class EndBattle
{
    ...
    private static void YourOptions()
    {
        ...
        panel.Find("OptionButton1").transform.Find("Panel").transform.Find("Panel").transform.Find("Button").GetComponent<Button>().onClick.AddListener(Option1);
        ...
        panel.Find("OptionButton2").transform.Find("Panel").transform.Find("Panel").transform.Find("Button").GetComponent<Button>().onClick.AddListener(Option2);
    ...
    {
        Gold = Random.Range(25, 50) * BattleSingleton.Instance.save.numberOfEnemies * BattleSingleton.Instance.save.enemyChallengeRating;
        Materials = Random.Range(10, 20) * BattleSingleton.Instance.save.numberOfEnemies * BattleSingleton.Instance.save.enemyChallengeRating;
    }
