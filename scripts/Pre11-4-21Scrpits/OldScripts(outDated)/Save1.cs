...
public class Save1
{
    ...
    {
        BinaryFormatter formatter = new BinaryFormatter();
        string path = "C:\\Users\\tbgoods\\Desktop\\my_game\\my_game_2_Alpha_0_3\\saves\\" + LastLoadedFile + "Item.fun";
        FileStream stream;
        try
        {
            stream = new FileStream(path, FileMode.Create);
    ...
    public List<Item> LoadInvetory(string whichFile)
    {
        string path = "C:\\Users\\tbgoods\\Desktop\\my_game\\my_game_2_Alpha_0_3\\saves\\" + whichFile + ".fun";
        if (File.Exists(path))
        {
    ...
    {
        float x = 0;
        DirectoryInfo directory = new DirectoryInfo("C:\\Users\\tbgoods\\Desktop\\my_game\\my_game_2_Alpha_0_3\\saves");
        string path = "C:\\Users\\tbgoods\\Desktop\\my_game\\my_game_2_Alpha_0_3\\saves";
        ...
        BinaryFormatter formatter = new BinaryFormatter();
        path = "C:\\Users\\tbgoods\\Desktop\\my_game\\my_game_2_Alpha_0_3\\saves\\save" + x.ToString() + ".fun";
        FileStream stream;
