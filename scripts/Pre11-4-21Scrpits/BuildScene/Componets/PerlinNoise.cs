...
public class PerlinNoise
{
    ...
    public float Noise(float width, float height, float maxWidth, float maxHeight,float scale, float offsetX, float offsetY, float heightScale, float lacunarity, float persistance, float octaves)
    {
        float y = 0;
